...
> [!NOTE]
> Image by <a href="https://pixabay.com/users/camera-man-16096197/?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=8249322">Sergio Cerrato - Italia</a> from <a href="https://pixabay.com//?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=8249322">Pixabay</a>
...
| alist                               | 便携版 | 网盘文件列表程序                      |
| Android Studio                      | 已安装 | Android 开发 IDE                      |
| AssetStudio                         | 便携版 | Unity 游戏资源提取工具                |
| AudioDecrypt                        | 便携版 | 音频解密工具                          |
| AutoClicker                         | 便携版 | 鼠标自动点击器                        |
| AutoHideMouseCursor                 | 便携版 | 自动隐藏鼠标光标工具                  |
| AutoHotkey                          | 已安装 | 自动化脚本/热键工具                   |
| Biu                                 | 便携版 | B 站第三方桌面客户端                  |
...
| Clash Verge                         | 已安装 | 代理客户端（Clash 核心）              |
...
| DWMBlurGlass                        | 便携版 | 窗口毛玻璃模糊特效                    |
| encrypt0r                           | 便携版 | 文件加密工具                          |
...
| FreeFileSync                        | 已安装 | 文件同步/备份工具                     |
| Freeplane                           | 已安装 | 思维导图工具                          |
| geek.exe (Geek Uninstaller)         | 便携版 | 软件卸载工具                          |
| genact                              | 便携版 | 假装在工作的摸鱼动画                  |
| GIMP                                | 已安装 | 开源图像编辑软件（类似 Photoshop）    |
| Git                                 | 已安装 | 分布式版本控制系统                    |
| GitHub Stars Manager                | 已安装 | GitHub Star 管理工具                  |
| Godot                               | 便携版 | 开源游戏引擎                          |
| Google Chrome                       | 已安装 | Google 浏览器                         |
...
| InputTip                            | 便携版 | 输入法状态（中/英）提示工具           |
| IntelliJ IDEA                       | 已安装 | JetBrains Java IDE                    |
| IrfanView                           | 已安装 | 老牌图像查看/编辑工具                 |
| Java JDK                            | 已安装 | Java 开发工具包                       |
| Jellyfin Server                     | 已安装 | 媒体服务器（视频/音乐/直播）          |
| JetBrains Toolbox                   | 已安装 | JetBrains IDE 版本管理工具            |
| Kazumi                              | 便携版 | 番剧/视频观看工具                     |
| Kdenlive                            | 已安装 | KDE 视频编辑器                        |
| KeyCastOW                           | 便携版 | 键盘按键屏幕显示                      |
| Krita                               | 已安装 | 开源数字绘画软件                      |
...
| NapCat                              | 便携版 | QQ 机器人框架                         |
| neofetch                            | 便携版 | 系统信息显示工具                      |
| Neovim                              | 已安装 | 现代 Vim 编辑器                       |
| nircmd                              | 便携版 | Windows 命令行工具集                  |
| Node.js                             | 已安装 | JavaScript 运行时                     |
| NotepadNext                         | 便携版 | Notepad++ 的跨平台替代品              |
| NVIDIA App                          | 已安装 | NVDIA 显卡控制/优化应用               |
| OBS Studio                          | 已安装 | 直播/录屏软件                         |
| Office Tool                         | 便携版 | Office 部署/管理工具                  |
| ONLYOFFICE                          | 已安装 | 开源办公套件                          |
| pandoc                              | 便携版 | 文档格式转换工具                      |
...
| Python                              | 已安装 | Python 编程语言                       |
| QGIS                                | 已安装 | 开源 GIS 地理信息系统                 |
| Qt                                  | 已安装 | 跨平台 C++ GUI 框架                   |
...
| scrcpy                              | 便携版 | 安卓手机投屏/控制                     |
| SDI_R2408 (Snappy Driver Installer) | 便携版 | 驱动安装工具                          |
| Shotcut                             | 便携版 | 开源视频编辑器                        |
| SmartContextMenu                    | 便携版 | 智能右键菜单扩展                      |
| SourceGit                           | 便携版 | Git 图形客户端                        |
| sqlite                              | 便携版 | SQLite 数据库工具                     |
...
| TranslucentSM                       | 便携版 | 任务栏透明工具                        |
| TrayS                               | 便携版 | 系统托盘美化工具                      |
| Umi-OCR                             | 便携版 | 离线文字识别（OCR）工具               |
| UniGetUI                            | 已安装 | Windows 包管理器图形界面（Winget UI） |
| Unity / Unity Hub                   | 已安装 | 游戏引擎/Unity 版本管理               |
| ventoy                              | 便携版 | 多系统启动 U盘制作工具                |
| VirtualBox                          | 已安装 | 开源虚拟机软件                        |
| Visual Studio Code                  | 已安装 | 代码编辑器                            |
| Visual Studio Community 2022        | 已安装 | 微软集成开发环境                      |
| VLC media player                    | 已安装 | 万能视频播放器                        |
| VSeeFace                            | 便携版 | VTuber 面部捕捉/模型显示              |
| Wallpaper Engine                    | 已安装 | 动态壁纸引擎（Steam）                 |
| WinaeroTweaker                      | 便携版 | Windows 系统优化/个性化设置           |
| WinRAR                              | 已安装 | 压缩解压工具                          |
...
| 米哈游启动器                        | 已安装 | 米哈游游戏启动器                      |
| 原神                                | 已安装 | 米哈游开放世界游戏                    |
| 崩坏：星穹铁道                      | 已安装 | 米哈游 RPG 游戏                       |
| 雷神加速器                          | 已安装 | 游戏加速器                            |
| 360杀毒                             | 已安装 | 杀毒软件                              |
| 360安全卫士                         | 已安装 | 系统安全优化工具                      |

---

当然，有很多典藏内容不应该被分享，如`E:\games`，`E:\Downloads\archivePackage`...
