...
<div class="cq-chat">
  ...
  <div class="cq-msg-row cq-msg-row--other">
    <div class="cq-avatar" style="background-image: url('/posts/daily-reset-android-app/assets/O.png');"></div>
    <div class="cq-bubble">
...
![alt text](assets/help.png)
  ...
  <div class="cq-msg-row cq-msg-row--self">
    <div class="cq-avatar" style="background-image: url('/posts/daily-reset-android-app/assets/len.png');"></div>
    <div class="cq-bubble">
      其实很简单的</div>
  </div>
